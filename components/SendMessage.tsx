...
const SendMessage = () => {
  ...
  const SERVICE_ID = "service_se2cgr1";
  const TEMPLATE_ID = "template_mqbkscw";
  const PUBLIC_KEY = "4cq-39GcCzkHJXzdc";
  ...
  return (
    <div
      className="w-[90%] max-w-[1200px] min-h-[466px] border-3 m-auto relative flex justify-center items-center px-4 py-8 mb-32 boxShadow mt-24"
      id="SendMessage"
    >
      <Image
        src="/smallIcons/sendMsgVector.png"
        className="absolute -top-8 md:right-88"
        width={100}
        height={100}
        alt="VectorStar"
      />
      <div className="w-full max-w-4/5 flex flex-col justify-center items-center">
        ...
        {showForm && (
          <form
            ...
            className="mt-8 w-full max-w-md bg-white p-6 rounded-lg shadow-lg flex flex-col gap-4 z-10"
          >
            <input
              type="text"
              name="name"
            ...
            <div className="flex gap-2">
              <button
                type="submit"
                className="flex-1 px-4 py-2 bg-[#F3ABCB] border-2 border-black rounded-full font-medium hover:bg-[#f5c2bb]"
              >
                Send
              </button>
              <button
                type="button"
                className="flex-1 px-4 py-2 border-2 border-black rounded-full font-medium"
